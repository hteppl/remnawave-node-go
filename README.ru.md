...
|------------------------|------------|
| v1.2.1                 | Ниже 2.7.0 |
| v1.3.0+ (в разработке) | 2.7.0+     |

> **Примечание:** Релиз, совместимый с Remnawave 2.7.0+, ещё не готов. Если вы используете Remnawave 2.7.0 или выше,
> дождитесь предстоящего релиза.
